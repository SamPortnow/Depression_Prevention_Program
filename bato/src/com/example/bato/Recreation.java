...
public class Recreation extends Activity {
	...
	//recreation values
	private EditText mvalue_recreation;
	private EditText mactivity_recreation;
	private EditText mactivity_recreation2;
	private EditText mactivity_recreation3;
	private EditText mactivity_recreation4;
	private EditText mactivity_recreation5;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mvalue_recreation=(EditText) findViewById(R.id.value_recreation);
		mactivity_recreation=(EditText) findViewById(R.id.activity_recreation);
		mactivity_recreation2=(EditText) findViewById(R.id.activity_recreation2);
		mactivity_recreation3=(EditText) findViewById(R.id.activity_recreation3);
		mactivity_recreation4=(EditText) findViewById(R.id.activity_recreation4);
		mactivity_recreation5=(EditText) findViewById(R.id.activity_recreation5);
	...
	private void populateFields()
{
		...
		Cursor activity = mDbHelper.fetchRecreationActivities(mRowId);
		if (activity.moveToFirst())
		{
		startManagingCursor(activity);
		mvalue_recreation.setText(activity.getString(
				activity.getColumnIndexOrThrow(ActivityDbAdapter.COLUMN_NAME_VALUE1_RECREATION)));
		mactivity_recreation.setText(activity.getString(
				activity.getColumnIndexOrThrow(ActivityDbAdapter.COLUMN_NAME_ACTIVITY1_RECREATION)));
		mactivity_recreation2.setText(activity.getString(
				activity.getColumnIndexOrThrow(ActivityDbAdapter.COLUMN_NAME_ACTIVITY2_RECREATION)));
		mactivity_recreation3.setText(activity.getString(
				activity.getColumnIndexOrThrow(ActivityDbAdapter.COLUMN_NAME_ACTIVITY3_RECREATION)));
		mactivity_recreation4.setText(activity.getString(
				activity.getColumnIndexOrThrow(ActivityDbAdapter.COLUMN_NAME_ACTIVITY4_RECREATION)));
		mactivity_recreation5.setText(activity.getString(
    ...
    private void saveState() { //here you save state. for when the activity ends! 
		...
		if (activity.moveToFirst())
		{
    	String value_recreation = mvalue_recreation.getText().toString();
        String activity1_recreation = mactivity_recreation.getText().toString();
        String activity2_recreation= mactivity_recreation2.getText().toString();
        String activity3_recreation=mactivity_recreation3.getText().toString();
        String activity4_recreation=mactivity_recreation4.getText().toString();
        String activity5_recreation=mactivity_recreation5.getText().toString();
        mDbHelper.updateRecreation(mRowId, value_recreation,  
        		activity1_recreation,  activity2_recreation,  activity3_recreation,
        		activity4_recreation,  activity5_recreation);
		...
		else
		{
	        ...
	        String activity4_recreation=mactivity_recreation4.getText().toString();
	        String activity5_recreation=mactivity_recreation5.getText().toString();
	        mDbHelper.createRecreation(mRowId, value_recreation,  
	        		activity1_recreation,  activity2_recreation,  activity3_recreation,
	        		activity4_recreation,  activity5_recreation);
		}
    }	
